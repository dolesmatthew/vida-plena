...
const HERO_IMG = 'https://media.base44.com/images/public/69e79428dcd983c7719be231/b5f50e107_generated_11360a49.png';
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pb-32 md:pb-40 pt-32">
        ...
        >
          ...
          <p className="font-sans text-lg md:text-xl text-alabaster/70 mt-6 max-w-xl leading-relaxed">
            A missional church in Naperville, IL — where every heritage 
            finds home through the love of Christ.
          </p>
